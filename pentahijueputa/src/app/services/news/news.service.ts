  ...
  private news = [
    {
      ...
      description: 'Primer chivo de pentahijueputa manada de locos auuuuu'
    },
    {
      id: '2',
  ...
  private photos = [
    {
      ...
      {
        link:'/assets/img/news/chivoEnMuncheee/4.jpg'
      },
      {
        link:'/assets/img/news/chivoEnMuncheee/5.jpg'
      },
      {
        link:'/assets/img/news/chivoEnMuncheee/6.jpg'
      },
      {
